...
# trajectory:
# -> grid of pedestrians: v = 1 m/s, distance = 0.5 m, start at x = 0 m
# ini-file:
# -> MA length in movement direction = 1 m
# -> MA length orthogonal to movement direction = 10 m
# -> lines at these positions: 4.5, 5, 5.5
# -> delta t = 35 frames, one frame interval
# number of peds in y direction = 10
# the pedestrians do not enter or cross the measurement area
# density, flow should be 0; velocity should be nan
...
delta_t_frames = 35 # frames of general frame interval
delta_t_seconds = delta_t_frames/fps # length of general time interval in seconds
num_frames = 35 # number of frames in trajectory
