...
## Methods
  ...
  version of `JPSreport` and can be chosen for the analysis. `Method_I` can use for time-series analysis of individual data. The four methods `method_A` to `method_D` are used to analyze the steady state.
