...
private:
     ...
     std::map<int, polygon_2d> _geoPolyMethod_Voronoi;
     ...
     std::vector<int> _StartFramesMethod_Voronoi;
     std::vector<int> _StopFramesMethod_Voronoi;
     ...
     std::vector<MeasurementArea_B*> _areaForMethod_Voronoi;
};
