...
# -> number of peds in y direction = 5
# ini-file:
# -> MA length in movement direction = 1 m
# -> number of cut polygons = 4
# -> dx = 0.25 m
# -> dt = 1 frame; delta t = 100 frames
# output velocity, density and flow values for dt vary because different numbers of 
# pedestrian columns are counted during each dt (number of peds varies between 5 and 0)
# the same number of pedestrians is counted for each dx
# there are not always pedestrians in the area during each dt -> dt output should contain nan values
