...
- **methods** indicates the parameters related to each measurement method. 
  ...
  - [Method C](2016-11-06-c.html): Classical method
...
<!-- ![Example Methode C]({{ site.baseurl }}/img/Figue4-3.png) -->

  - [Method D](2016-11-07-d.html): Voronoi method
