...
# trajectory:
# -> grid of pedestrians: v = 1.3 m/s, distance = 0.5 m, start at x = 4.5 m
# -> number of peds in y direction = 10
# ini-file:
# -> MA length in movement direction = 1 m
# -> number of cut polygons = 4
# -> dx = 0.25 m
# -> dt = 5 frames; delta t = 100 frames
# output velocity, density and flow values for dt vary because different numbers of 
# pedestrian columns are counted during each dt (number of peds varies between 20, 30, 40)
# the same number of pedestrians is counted for each dx
# there are always some pedestrians in the area (no nan values)
...
dt_frames = 5 # frames of small frame interval
