...
| Method |  | $$v$$ | $$\rho$$ | $$J_s$$ |
| *A* | ![Method_A]({{ site.baseurl }}/img/jpsreport_Method_A.png) |  $$\langle v \rangle_{\Delta t}=\frac{1}{N^{\Delta t}}\sum_{i=1}^{N^{\Delta t}} v_i(t)$$ | | $$\langle J \rangle_{\Delta t}=\frac{N^{\Delta t}}{t_N^{\Delta t} - t_1^{\Delta t}}$$ |
