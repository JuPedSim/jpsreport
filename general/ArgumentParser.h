...
private:
     ...
     std::vector<int> _areaIDforMethod_Voronoi;
     float _grid_size_X;
     float _grid_size_Y;
     int _log;
     ...
     std::vector<int> _start_frames_Method_Voronoi;
     std::vector<int> _stop_frames_Method_Voronoi;
...
public:
     ...
     bool GetIsMethod_Voronoi() const;
     ...
     std::vector<int> GetAreaIDforMethod_Voronoi() const;
     ...
     std::vector<int> GetStartFramesMethod_Voronoi() const;
     std::vector<int> GetStopFramesMethod_Voronoi() const;
